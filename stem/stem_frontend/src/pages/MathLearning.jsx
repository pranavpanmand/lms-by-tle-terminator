...
return (
  <div
    ...
    data-testid="math-learning-page">
    {/* Hero Header */}
    <div className="relative overflow-hidden border-b border-slate-800">
      ...
      <div className="relative z-10 container mx-auto px-6 md:px-12 py-14">
        ...
        <div className="flex items-center gap-6">
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-indigo-600 to-blue-700 flex items-center justify-center shadow-lg shadow-blue-500/30">
          ...
          <div>
            ...
            <p className="text-lg text-slate-300 mt-2">
              Practice, solve, and dominate math challenges.
            </p>
          </div>
        </div>
      </div>
