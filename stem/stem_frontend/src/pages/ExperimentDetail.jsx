  ...
  return (
    <div
      ...
      <div
        ...
        style={{
          background: `linear-gradient(135deg, ${subjectColor}15 0%, ${subjectColor}35 100%)`,
        }}>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-lg">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 bg-indigo-500/30 rounded-xl flex items-center justify-center shadow-sm">
                <Lightbulb
          ...
          {/* Safety Notes */}
          <div className="bg-amber-900/10 rounded-3xl border border-amber-700/20 shadow-lg p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 bg-amber-700/20 rounded-xl flex items-center justify-center shadow-sm">
                <AlertTriangle
          ...
          {/* Steps */}
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl shadow-lg p-8">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl shadow-lg p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 bg-purple-500/30 rounded-xl flex items-center justify-center shadow-sm">
                <Target className="h-6 w-6 text-purple-200" strokeWidth={2.5} />
              </div>
              <h2 className="text-2xl font-bold text-white">
                What You'll Learn
              </h2>
